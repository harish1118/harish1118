...
s.visitor = Visitor.getInstance("69AA402551915FB10A490D4D@AdobeOrg");
// AppMeasurement instance example
var appMeasurement = new AppMeasurement();
appMeasurement.visitor = s.visitor;
...
/*Set standard video metadata*/    
    var standardVideoMetadata = {};
        standardVideoMetadata[MediaHeartbeat.VideoMetadataKeys.EPISODE] = "Episode 1";
        standardVideoMetadata[MediaHeartbeat.VideoMetadataKeys.SHOW] = "Game of Thrones";
        standardVideoMetadata[MediaHeartbeat.VideoMetadataKeys.STREAM_FORMAT] = "Youtube Uploaded Offline";
        standardVideoMetadata[MediaHeartbeat.VideoMetadataKeys.SEASON] ="7";
        standardVideoMetadata[MediaHeartbeat.VideoMetadataKeys.ASSET_ID]=event.target.getVideoData().video_id;
        standardVideoMetadata[MediaHeartbeat.VideoMetadataKeys.GENRE]="Drama"; 
